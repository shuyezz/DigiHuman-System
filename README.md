...
🎬 **演示视频（2分钟）**
👉 [https://b23.tv/BV19YASz9Ed3](https://b23.tv/BV19YASz9Ed3)
...
![System Architecture](docs/digitalhuman-架构.png)
...
1. 用户输入提示词
2. 后端调用 Ollama LLM 生成文本
3. 文本送入：

   * GPT-SoVITS → 语音合成
   * Text2Emotion → 情绪权重分析
4. 后端生成符合 VRM 协议的数据格式
5. 前端通过 Three.js 实时驱动模型
6. Redis 进行缓存复用
...
![Data Driven](docs/digitalhuman-数据驱动.png)
...
仓库地址：
👉 [https://github.com/shuyezz/DigiHuman-app](https://github.com/shuyezz/DigiHuman-app)
...
仓库地址：
👉 [https://github.com/shuyezz/DigiHuman-backend](https://github.com/shuyezz/DigiHuman-backend)
